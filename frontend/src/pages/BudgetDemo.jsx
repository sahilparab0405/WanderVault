  ...
  return (
    <div className="min-h-screen bg-bg page-content">
      <div className="max-w-3xl mx-auto px-6 sm:px-6 py-8 space-y-8">
        ...
        {/* Page header */}
        <div>
          <h1 className="text-2xl font-bold text-navy mb-1" style={{ fontFamily: "'Poppins', sans-serif" }}>
            Budget Analytics
          </h1>
          <p className="text-text-secondary text-sm" style={{ fontFamily: "'Inter', sans-serif" }}>
            Preview of budget tracking across different trip scenarios.
          </p>
        </div>
        ...
        <div>
          <h2
            className="text-xs font-semibold text-success mb-3 flex items-center gap-1.5 uppercase tracking-wider"
        ...
        <div>
          <h2
            className="text-xs font-semibold text-danger mb-3 flex items-center gap-1.5 uppercase tracking-wider"
            style={{ fontFamily: "'Inter', sans-serif" }}
          >
            <AlertTriangle size={14} strokeWidth={1.5} />
            Over Budget — Manali Winter Trip
          </h2>
