            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" id="register-name" name="name" required autoComplete="name"
                  ...
                  className={`w-full border rounded-xl pl-10 pr-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary/30 bg-bg text-navy transition-colors ${fieldErrors.name ? 'border-danger' : 'border-border focus:border-primary'}`}
