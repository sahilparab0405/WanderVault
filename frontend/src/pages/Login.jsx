  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-6">
      ...
      <div className="relative z-10 w-full max-w-[400px]">
        ...
        {/* Logo */}
        <div
          className="bg-white rounded-xl p-8 border border-white/20"
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            ...
            >
              {loading ? (
                <><span className="w-4 h-4 border-2 border-white border-t-transparent rounded-xl animate-spin" />Signing in...</>
              ) : (
