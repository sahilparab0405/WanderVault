      ...
      <div className="px-6 py-3 border-b border-border flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-1">
            <div className="w-2.5 h-2.5 rounded-xl bg-primary" />
            <span className="text-[10px] text-text-muted" style={{ fontFamily: "'Inter', sans-serif" }}>Destination</span>
          </div>
          <div className="flex items-center gap-1">
             <div className="w-2.5 h-2.5 rounded-xl" style={{ background: '#FF6B35' }}/>
             <span className="text-[10px] text-text-muted">Dining</span>
          </div>
          <div className="flex items-center gap-1">
             <div className="w-2.5 h-2.5 rounded-xl" style={{ background: '#1a2b4a' }}/>
